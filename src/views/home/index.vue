...
<div class="home-container">
    ...
    <banner-home :key="item.id"  :postion="index === 0 ? 'left' : 'right'" v-for="(item, index) in data" :imgUrl="item.banner" :title="item.title" :subTitle="item.subTitle" :id="item.id" :mark="item.mark" ></banner-home>
